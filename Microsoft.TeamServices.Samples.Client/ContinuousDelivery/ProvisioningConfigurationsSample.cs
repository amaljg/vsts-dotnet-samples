namespace Microsoft.TeamServices.Samples.Client.ContinuousDelivery
{
    ...
    using Microsoft.VisualStudio.Services.PortalExtension.WebApi;
    using Microsoft.VisualStudio.Services.PortalExtension.WebApi.Clients;
    using Microsoft.VisualStudio.Services.PortalExtension.WebApi.Contracts;
    ...
    public class ProvisioningConfigurationsSample : ClientSample
    {
        ...
        [ClientSampleMethod]
        public ProvisioningConfiguration CreateProvisioningConfigurationForDeployingNodeJsWithGulpApplicationInExternalGitRepoToWindowsAppServiceUsingTestEnvironment()
        {
            this.dataProvider = new SampleDataProvider(this.Context);
            ...
            IReadOnlyDictionary<string, object> additionalProperties = null)
        {
            ...
            // Add test target if required.
            // Note: Targets should be added in the order they want to be deployed to.
